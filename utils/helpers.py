...
async def clean_and_parse_filename(name: str, cache: dict = None):
    ...
    # --- 1. PEHLE RANGE CHECK KAREIN (HANDLES: [E01 - E05], Ep 01 04, Ep 01-04, 01-04, 1 to 4) ---
    range_patterns = [
        # ✅ Added: Matches bracketed episode ranges like [E01 - E05], [E06 - E09]
...
async def create_post(client, user_id, messages, cache: dict):
    ...
    for info in media_info_list:
        ...
        ep_text = ""
        # ✅ Fixed: Preserves episode ranges like EP 01-05
